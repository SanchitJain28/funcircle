  ...
  return (
    <div className="mx-4 my-2 bg-black text-white rounded-lg">
      <div className="space-y-4">
        {selectedVenue ? (
          <div
            className="bg-black border border-[#8A36EB] rounded-lg p-4 cursor-pointer transition-colors hover:bg-[#0a0a0a] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8A36EB]"
