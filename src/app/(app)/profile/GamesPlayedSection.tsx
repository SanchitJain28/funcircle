          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-[#F9761C] to-[#FF8A3D] rounded-xl blur-sm opacity-50"></div>
          ...
          {!data?.length ? (
            <div className="text-center py-12 sm:py-16">
              <div className="relative mx-auto mb-6">
                <div className="absolute inset-0 bg-gradient-to-r from-[#F9761C] to-[#FF8A3D] rounded-full blur-lg opacity-30 w-16 h-16 sm:w-20 sm:h-20"></div>
              ...
              {data.map((game, index) => (
                ...
                >
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    <div className="relative">
                      <div className="absolute inset-0 bg-gradient-to-r from-[#F9761C] to-[#FF8A3D] rounded-lg blur-sm opacity-40 group-hover:opacity-60 transition-opacity"></div>
          ...
          <div className="sticky top-0 z-10 bg-[#1a1a1a]/95 backdrop-blur-xl border-b border-gray-800/50 ">
            ...
            <DialogHeader className="">
              <DialogTitle className="text-center mb-6">
                ...
                <p className="text-[#F9761C] text-sm font-semibold mb-4">
                  {selectedGame && formatGameDate(selectedGame.date)}
                </p>
              </DialogTitle>
            </DialogHeader>
          </div>
              ...
              <div className="space-y-4 mt-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <span className="text-xs text-gray-400 bg-gray-800 px-3 py-1 rounded-full">
                    {
                      selectedGame.ticket_members.filter(
