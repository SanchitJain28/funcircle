    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-lg font-semibold">₹599/mo</p>
          <motion.p
          ...
          <p className="py-2 border-t border-pink-700 font-bold">₹599</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-2xl font-bold">1</p>
          <p className="text-lg">month</p>
          <p className="text-lg font-semibold">₹1199/mo</p>
          <motion.p
            className="text-lg text-pink-700 font-bold"
            animate={{
              scale: [1, 1.05, 1],
          ...
          <p className="py-2 border-t border-pink-700 font-bold">₹1199</p>
        </motion.div>
      </motion.div>
        ...
        {tabs === "PRO" ? (
          ...
          >
            <motion.div
              ...
              variants={itemVariants}
            >
              <motion.p className="my-1 font-medium" variants={itemVariants}>
                CURRENT SPORTS
              </motion.p>
              <motion.div
            ...
            >
              ...
              >
                {[
                  ...
                  {
                    text: "2 entries can be used by your friends",
                    badge: false,
                  },
      ...
      >
       <Link href="/funcircle">Continue Subscription</Link> 
      </motion.button>
    </motion.div>
  );
};
