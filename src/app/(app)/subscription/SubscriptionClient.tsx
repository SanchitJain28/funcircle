...
export default function SubscriptionClient() {
  const { user, showSignInRequired } = useAuth();
  ...
  return (
    <>
      ...
      <div className="min-h-screen p-4 md:p-8">
        <div className="max-w-2xl mx-auto">
          <Card
            className={`bg-gradient-to-br ${getSubscriptionColor(type)} backdrop-blur-sm shadow-2xl border-2 overflow-hidden`}
          >
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-4">
                  <div className="flex items-center justify-between p-4 bg-slate-700/30 rounded-xl border border-slate-600/30 hover:bg-slate-700/40 transition-colors">
                    ...
                    <Badge
                      variant="secondary"
                      className="bg-purple-500/20 text-purple-300 border-purple-500/30 capitalize font-semibold"
                    >
                      {type}
                    </Badge>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-slate-700/30 rounded-xl border border-slate-600/30 hover:bg-slate-700/40 transition-colors">
                    ...
                    <div className="text-right">
                      <div className="flex flex-wrap gap-1 justify-end">
                        {playing_date_and_time.playingDays.map(
                          (day: string) => (
                            <Badge
                              key={day}
                              variant="outline"
