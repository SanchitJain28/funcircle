    ...
    <div className="">
      ...
      <div className="flex flex-col bg-black">
        ...
        <div className="flex justify-center mt-8">
          <button className="text-white px-4 py-[10px] bg-[#1F0700] font-bold border border-red-800 text-sm bg-zinc-800 font-bold rounded-xl font-sans ">YOUR MOOD YOUR VIBE</button>
        </div>

        {/* //PARA1 */}
        <div className="flex justify-center my-8">
          <p className="text-center font-sans text-3xl font-bold">Meet New Friends<br /> Based on Your Mood <br /> &
            Location with <br /> Vibe IRL!</p>
        </div>
      ...
      <div className="flex flex-col px-4 text-black lg:px-80 lg:py-12 bg-zinc-100 ">
        ...
        <div className="lg:flex lg:flex-row justify-between">
          <div className="flex flex-col">
            <p className="text-2xl lg:text-4xl mt-4 font-[__sharpGrotesk_34461d] font-bold ">What is fun circle ?</p>
