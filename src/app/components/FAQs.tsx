    ...
    <div>
      ...
      <div className="lg:px-80 px-4 py-8 lg:py-20">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1" className=" bg-red-500 text-white p-4 rounded-lg">
          ...
          <AccordionItem value="item-2" className="bg-red-500 text-white p-4 rounded-lg">
          ...
          <AccordionItem value="item-3" className="bg-red-500 text-white p-4 rounded-lg">
          ...
          <AccordionItem value="item-4" className="bg-red-500 text-white p-4 rounded-lg">
          ...
          <AccordionItem value="item-5" className="bg-red-500 text-white p-4 rounded-lg">
